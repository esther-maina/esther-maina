...
TypeScript · JavaScript · Playwright · Postman · SQL  · Git · GitHub Actions · Jira

---

## QA Roadmap — August 2026

- [ ] Month 1 — Manual testing foundations · test case design · defect lifecycle · Jira
- [ ] Month 2 — API testing with Postman · SQL data validation · Newman CI
- [ ] Month 3 — UI automation with Playwright and TypeScript · Page Object Model
- [ ] Month 4 — CI/CD integration with GitHub Actions · pipeline reporting
- [ ] Month 5 — Performance testing with k6 · ISTQB CTFL preparation
- [ ] Month 6 — Capstone project · certification · market entry
